...
//            }
            ...
            if (pozitie == Pipeline_Blue.SkystonePosition.LEFT && pas == 0) {
                ...
                pas++;
            } else if (pozitie == Pipeline_Blue.SkystonePosition.CENTER && pas == 0) {
...
//                                motorGR.setPower(power2 + Kff2);
                        ...
                        .build();
                TrajectorySequence coaie = drive.trajectorySequenceBuilder(new Pose2d())
                        .lineToConstantHeading(new Vector2d(1, 0))
                        .addDisplacementMarker(() -> {
                ...
                pas++;
            } else if (pozitie == Pipeline_Blue.SkystonePosition.RIGHT && pas == 0) {
                TrajectorySequence TrajDr = drive.trajectorySequenceBuilder(new Pose2d())
                        .lineToConstantHeading(new Vector2d(28, -15))
                        .waitSeconds(0.5)
                        .lineToConstantHeading(new Vector2d(26, -22))
                        .lineToLinearHeading(new Pose2d(26.1, -20, Math.toRadians(90)))
                        .addDisplacementMarker(() -> {
                            motorRoata.setPower(-0.7);
                        })
                        .waitSeconds(1)
                        .lineToConstantHeading(new Vector2d(30, -22))
                        .addDisplacementMarker(() -> {
                            motorRoata.setPower(0);
                        })
                        .waitSeconds(1)
